...
Vector<Vector<Vector<GrammarCharacter>>> tmp(static_cast<std::size_t>(TokenType::COMMENT)-1);

for (std::size_t index = 0; index < static_cast<std::size_t>(TokenType::COMMENT); ++index) {
	tmp.push_back(Vector<Vector<GrammarCharacter>>(static_cast<std::size_t>(GrammarVariable::ROOT) - 1, Vector<GrammarCharacter>()));
}

    tmp[static_cast<std::size_t>(TokenType::EPSILON)]
    ...
    tmp[static_cast<std::size_t>(TokenType::PLUS)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::PLUS)]
	...
	tmp[static_cast<std::size_t>(TokenType::MINUS)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::MINUS)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(GrammarVariable::OP), GrammarCharacter(GrammarVariable::EXP))};
	tmp[static_cast<std::size_t>(TokenType::MINUS)]
	...
	tmp[static_cast<std::size_t>(TokenType::COLON)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::COLON)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(GrammarVariable::OP), GrammarCharacter(GrammarVariable::EXP))};
	tmp[static_cast<std::size_t>(TokenType::COLON)]
	...
	tmp[static_cast<std::size_t>(TokenType::ASTERISK)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::ASTERISK)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(GrammarVariable::OP), GrammarCharacter(GrammarVariable::EXP))};
	tmp[static_cast<std::size_t>(TokenType::ASTERISK)]
	...
	tmp[static_cast<std::size_t>(TokenType::LESS_THAN)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::LESS_THAN)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(GrammarVariable::OP), GrammarCharacter(GrammarVariable::EXP))};
	tmp[static_cast<std::size_t>(TokenType::LESS_THAN)]
	...
	tmp[static_cast<std::size_t>(TokenType::GREATER_THAN)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::GREATER_THAN)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(GrammarVariable::OP), GrammarCharacter(GrammarVariable::EXP))};
	tmp[static_cast<std::size_t>(TokenType::GREATER_THAN)]
	...
	tmp[static_cast<std::size_t>(TokenType::EQUALITY)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::EQUALITY)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(GrammarVariable::OP), GrammarCharacter(GrammarVariable::EXP))};
	tmp[static_cast<std::size_t>(TokenType::EQUALITY)]
	...
	tmp[static_cast<std::size_t>(TokenType::ASSIGNMENT)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};

	tmp[static_cast<std::size_t>(TokenType::WHATEVER)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::WHATEVER)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(GrammarVariable::OP), GrammarCharacter(GrammarVariable::EXP))};
	tmp[static_cast<std::size_t>(TokenType::WHATEVER)]
	...
	tmp[static_cast<std::size_t>(TokenType::NOT)]
	...
	tmp[static_cast<std::size_t>(TokenType::LOGICAL_AND)]
        [static_cast<std::size_t>(GrammarVariable::INDEX)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::LOGICAL_AND)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(GrammarVariable::OP), GrammarCharacter(GrammarVariable::EXP))};
	tmp[static_cast<std::size_t>(TokenType::LOGICAL_AND)]
	...
	tmp[static_cast<std::size_t>(TokenType::SEMICOLON)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(TokenType::EPSILON))};

	tmp[static_cast<std::size_t>(TokenType::PARENTHESIS_OPEN)]
        [static_cast<std::size_t>(GrammarVariable::EXP)] = {(GrammarCharacter(GrammarVariable::EXP_2), GrammarCharacter(GrammarVariable::OP_EXP))};
	tmp[static_cast<std::size_t>(TokenType::PARENTHESIS_OPEN)]
	...
	tmp[static_cast<std::size_t>(TokenType::PARENTHESIS_CLOSE)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(TokenType::EPSILON))};

	tmp[static_cast<std::size_t>(TokenType::CURLY_BRACKET_OPEN)]
        [static_cast<std::size_t>(GrammarVariable::DECLS)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::CURLY_BRACKET_OPEN)]
	...
	tmp[static_cast<std::size_t>(TokenType::CURLY_BRACKET_CLOSE)]
        [static_cast<std::size_t>(GrammarVariable::STATEMENTS)] = {(GrammarCharacter(TokenType::EPSILON))};

    tmp[static_cast<std::size_t>(TokenType::SQUARE_BRACKET_OPEN)]
	...
	tmp[static_cast<std::size_t>(TokenType::SQUARE_BRACKET_CLOSE)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(TokenType::EPSILON))};

	tmp[static_cast<std::size_t>(TokenType::INTEGER)]
        [static_cast<std::size_t>(GrammarVariable::EXP)] = {(GrammarCharacter(GrammarVariable::EXP_2), GrammarCharacter(GrammarVariable::OP_EXP))};
	tmp[static_cast<std::size_t>(TokenType::INTEGER)]
        [static_cast<std::size_t>(GrammarVariable::EXP_2)] = {(GrammarCharacter(TokenType::INTEGER))};

	tmp[static_cast<std::size_t>(TokenType::IDENTIFIER)]
        [static_cast<std::size_t>(GrammarVariable::DECLS)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::IDENTIFIER)]
        [static_cast<std::size_t>(GrammarVariable::ARRAY)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::IDENTIFIER)]
	...
	tmp[static_cast<std::size_t>(TokenType::IF)]
        [static_cast<std::size_t>(GrammarVariable::DECLS)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::IF)]
        [static_cast<std::size_t>(GrammarVariable::STATEMENTS)] = {(GrammarCharacter(GrammarVariable::STATEMENT), GrammarCharacter(TokenType::SEMICOLON), GrammarCharacter(GrammarVariable::STATEMENTS))};
	tmp[static_cast<std::size_t>(TokenType::IF)]
	...
	tmp[static_cast<std::size_t>(TokenType::ELSE)]
        [static_cast<std::size_t>(GrammarVariable::STATEMENTS)] = {(GrammarCharacter(GrammarVariable::STATEMENT), GrammarCharacter(TokenType::SEMICOLON), GrammarCharacter(GrammarVariable::STATEMENTS))};
	tmp[static_cast<std::size_t>(TokenType::ELSE)]
        [static_cast<std::size_t>(GrammarVariable::OP_EXP)] = {(GrammarCharacter(TokenType::EPSILON))};

	tmp[static_cast<std::size_t>(TokenType::WHILE)]
        [static_cast<std::size_t>(GrammarVariable::DECLS)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::WHILE)]
        [static_cast<std::size_t>(GrammarVariable::STATEMENTS)] = {(GrammarCharacter(GrammarVariable::STATEMENT), GrammarCharacter(TokenType::SEMICOLON), GrammarCharacter(GrammarVariable::STATEMENTS))};
	tmp[static_cast<std::size_t>(TokenType::WHILE)]
	...
	tmp[static_cast<std::size_t>(TokenType::READ)]
        [static_cast<std::size_t>(GrammarVariable::DECLS)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::READ)]
        [static_cast<std::size_t>(GrammarVariable::STATEMENTS)] = {(GrammarCharacter(GrammarVariable::STATEMENT), GrammarCharacter(TokenType::SEMICOLON), GrammarCharacter(GrammarVariable::STATEMENTS))};
	tmp[static_cast<std::size_t>(TokenType::READ)]
	...
	tmp[static_cast<std::size_t>(TokenType::WRITE)]
        [static_cast<std::size_t>(GrammarVariable::DECLS)] = {(GrammarCharacter(TokenType::EPSILON))};
	tmp[static_cast<std::size_t>(TokenType::WRITE)]
        [static_cast<std::size_t>(GrammarVariable::STATEMENTS)] = {(GrammarCharacter(GrammarVariable::STATEMENT), GrammarCharacter(TokenType::SEMICOLON), GrammarCharacter(GrammarVariable::STATEMENTS))};
	tmp[static_cast<std::size_t>(TokenType::WRITE)]
	...
	tmp[static_cast<std::size_t>(TokenType::INT)]
        [static_cast<std::size_t>(GrammarVariable::PROG)] = {(GrammarCharacter(GrammarVariable::DECLS), GrammarCharacter(GrammarVariable::STATEMENTS))};
	tmp[static_cast<std::size_t>(TokenType::INT)]
